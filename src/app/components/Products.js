...
const markets = [
    ...
    },
    {
        ...
        description: "Innovative pressure controllers, flow sensors, and microfluidic chips for organ-on-chip research, droplet generation, cell sorting, and nanoparticle synthesis.",
        icon: "ph-dna",
