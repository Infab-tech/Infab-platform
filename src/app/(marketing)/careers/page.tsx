          ...
          {jobs.length > 0 ? (
              ...
              {jobs.map((job) => (
                <div key={job.id} className="rounded-2xl border border-[var(--border-primary)] bg-[var(--bg-secondary)] p-8 transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent-primary)]/40 hover:shadow-xl hover:shadow-[var(--accent-primary)]/5">
                  ...
                  <div className="border-t border-[var(--border-primary)] pt-6 flex justify-end">
                    <Link
                      href={`mailto:info@infabsemi.com?subject=Application for ${encodeURIComponent(job.title)}`}
            ...
            <div className="rounded-2xl border border-[var(--border-primary)] bg-[var(--bg-secondary)] p-12 text-center">
              ...
              <p className="text-[var(--text-secondary)] mb-6">
                We aren&apos;t actively hiring for any specific roles at the moment, but we&apos;re always eager to meet talented people.
              </p>
              <Link
                href="mailto:info@infabsemi.com?subject=General Application"
                className="inline-flex h-10 items-center justify-center rounded-md border border-[var(--accent-primary)]/40 px-6 text-xs font-semibold uppercase tracking-wider text-[var(--accent-primary)] transition-all hover:bg-[var(--accent-primary)] hover:text-[var(--bg-primary)]"
              >
