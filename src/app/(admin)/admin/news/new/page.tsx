...
import { addNewsArticle } from '@/app/actions/admin';
...
export default function NewNewsArticlePage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setError(null);
    const result = await addNewsArticle(new FormData(e.currentTarget));
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-10 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold mb-1 text-[var(--text-primary)]">New Article</h1>
          <p className="text-[var(--text-secondary)]">Add a press release, award, or company update to the public News page.</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              placeholder="e.g., INFAB Signs MoU with HAL for Avionics Pressure Sensors"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                type="date" id="publishedAt" name="publishedAt" required defaultValue={today}
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              placeholder="Write a 2–4 sentence summary of the announcement or event…"
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-[var(--text-secondary)]">Link to the full press release or external coverage. Displayed as a &ldquo;Read More&rdquo; button.</p>
          </div>

          {/* Publish toggle */}
          <div className="flex items-center gap-3 p-4 bg-[var(--text-primary)]/[0.02] border border-[var(--text-primary)]/10 rounded-xl">
            <input
              type="checkbox" id="isPublished" name="isPublished" defaultChecked
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)]">Uncheck to save as a draft — it won&apos;t appear on the public News page.</p>
            </div>
          </div>
