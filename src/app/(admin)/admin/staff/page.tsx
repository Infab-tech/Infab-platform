...
export const metadata = {
    title: 'Staff Access & Settings | Admin Console',
};
...
export default async function AdminStaffPage() {
    ...
    const isEmailEnabled = await getAdminEmailNotificationSetting();
        ...
        <div className="max-w-4xl mx-auto space-y-12">
            <div>
                <div className="mb-6">
                    ...
                    <p className="text-[var(--text-secondary)]">Manage platform-wide configuration.</p>
                </div>
                <AdminSettingsToggle initialValue={isEmailEnabled} />
            </div>
